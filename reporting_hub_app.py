...
def build_reporting_hub_pdf(
    ...
    _draw_table_paged(
        ...
        bottom_margin=0.7 * inch,
        font_size=6,
        page_title="Transactions — Filtered Detail",
    )
    ...
    def _build_calendar_pdf_bytes(
        ...
        if not tbl_needs.empty:
            ...
            _draw_wrapped_table_pages(
                "Needs Service",
                tbl_needs,
                ["Name", "Last Service Type", "Date of Last service"],
            )
        ...
        if not tbl_over.empty:
            ...
            _draw_wrapped_table_pages(
                "Overdue",
                tbl_over,
                ["Name", "Next Service Type", "Remaining"],
            )
